    ...
    <div id="main">
      ...
      <form class="text-center" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post">
        <input required type="date" name="date"
          value="<?php if(isset($session['date'])) echo $session['date']; ?>">
        <div class="space"></div>
        <div class="btn btn-info"><a href="paso2.php">ATRÁS</a></div>
