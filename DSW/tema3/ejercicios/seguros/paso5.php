...
<body>
    ...
    <div id="main">
      ...
      <ul>
        <li>Marca: <?php echo $session['brand']; ?></li>
        <li>Tipo de comustible: <?php echo $session['fuel']; ?></li>
        <li>Fecha de compra: <?php echo $session['date']; ?></li>
        <li>Email: <?php echo $session['email']; ?></li>
      </ul>


      <form class="text-center" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post">
        <div class="btn btn-info"><a href="paso3.php">ATRÁS</a></div>
