    ...
    <div id="main">
      ...
      <form class="text-center" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post">
        <input type="radio" name="fuel"
          <?php if(isset($session['fuel']) && $session['fuel'] == 'diesel') echo 'checked' ?>
          value="diesel"> Diésel
        <input type="radio" name="fuel"
          <?php if(isset($session['fuel']) && $session['fuel'] == 'gasolina') echo 'checked' ?>
          value="gasolina"> Gasolina
        <div class="space"></div>
        <div class="btn btn-info"><a href="index.php">ATRÁS</a></div>
