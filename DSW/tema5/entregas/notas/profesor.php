...
<body bgcolor="#11AAEE" onLoad="document.getElementById('contenido').src = 'usuarios.html';">
	...
	<div name="menu" style="position:absolute; left:410px; top:15px; width:150px; height:155px; background:#DDDDDD;
		...
		<button type="button" class="boton" onClick="document.getElementById('contenido').src = 'asignaturas.html';" onMouseEnter="botonMouseEnter(this);" onMouseOut="botonMouseOut(this);">ASIGNATURAS</button>
	...
	<!-- todo el contenido esta en este iframe -->
