...
<head>
    ...
    <title>Repaso - Ejercicio 2</title>
...
<body>
    ...
    <div id="profile">
        ...
        <div class="collapse navbar-collapse" id="navbar">
            <ul class="nav">
              <li><a href="ejercicio1.php">Ejercicio 1 - Subida de Ficheros</a></li>
              <li class="active"><a href="ejercicio2.php">Ejercicio 2 - XML</a></li>
    ...
    <div id="main">
      <?php
        ...
        ?>
      	...
      	<table class="table">
          <th>Título</th><th>Autor</th><th>Precio</th>
          <?php
          foreach ($libros as $libro) {
        		echo "<tr>
                    <td>".$libro['titulo']."</td>
                    <td>".$libro['autor'];
        		if ("Si" == $libro['novedad']) echo"  <img width='24px' src='img/new.png'>";
          		echo "</td>
                    <td>".$libro['precio']."</td>
                  </tr>";
        	}
