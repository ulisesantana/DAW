...
header("Content-type: text/javascript");
  if (isset($_GET['id'])) {
    ...
    if ($id == 'video1-container') {
      $video = "<iframe width='560' height='315' src='https://www.youtube.com/embed/5l5Xn_LOEY4"
      .$paramVideo."></iframe>";
    } else {
      $video = "<iframe width='560' height='315' src='https://www.youtube.com/embed/voywIbE8P7M"
      .$paramVideo."></iframe>";
    }
